...
![image-20251122170923723](/pics/image-20251122170923723.png)

* 使用一台联网的计算机进入[modelscope.cn/]()，点击**模型库**选择一个需要部署的模型，这里我选择**qwen2.5-3b-instruct**作为样例，搜索时加入**gguf**关键词。

![image-20251122171201275](/pics/image-20251122171201275.png)

* 进入**模型文件**，选择**qwen2.5-3b-instruct-q4_k_m.gguf**作为样例，将其下载到本地的**qwen2.5-3b**文件夹中。

![image-20251122171236505](/pics/image-20251122171236505.png)
...
![image-20251122170923723](/pics/image-20251122152121835.png)

* 选择模型提供方、Ollama，点击获取，可自动获取当前Ollama已部署的模型，加入后即可。

![image-20251122170923723](/pics/image-20251122152144952.png)

* 点击模型的齿轮⚙按钮，可对模型的基础配置进行更改。

![image-20251122170923723](/pics/image-20251122152353611.png)

* 返回模型对话界面，点击新建对话，可在右下角选择对话模型。

![image-20251122170923723](/pics/image-20251122152511672.png)
